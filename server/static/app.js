var cr=Object.defineProperty;var va=Object.getOwnPropertyDescriptor;var Ee=(r,t)=>()=>(r&&(t=r(r=0)),t);var ya=(r,t)=>{for(var e in t)cr(r,e,{get:t[e],enumerable:!0})};var d=(r,t,e,a)=>{for(var o=a>1?void 0:a?va(t,e):t,i=r.length-1,n;i>=0;i--)(n=r[i])&&(o=(a?n(t,e,o):n(o))||o);return a&&o&&cr(t,e,o),o};var Pt,Fr=Ee(()=>{Pt=class{constructor(t){this._map=new Map,this._roundAverageSize=!1,this.totalSize=0,t?.roundAverageSize===!0&&(this._roundAverageSize=!0)}set(t,e){let a=this._map.get(t)||0;this._map.set(t,e),this.totalSize+=e-a}get averageSize(){if(this._map.size>0){let t=this.totalSize/this._map.size;return this._roundAverageSize?Math.round(t):t}return 0}getSize(t){return this._map.get(t)}clear(){this._map.clear(),this.totalSize=0}}});function Ye(r){return r==="horizontal"?"width":"height"}var pe,Gr=Ee(()=>{pe=class{_getDefaultConfig(){return{direction:"vertical"}}constructor(t,e){this._latestCoords={left:0,top:0},this._direction=null,this._viewportSize={width:0,height:0},this.totalScrollSize={width:0,height:0},this.offsetWithinScroller={left:0,top:0},this._pendingReflow=!1,this._pendingLayoutUpdate=!1,this._pin=null,this._firstVisible=0,this._lastVisible=0,this._physicalMin=0,this._physicalMax=0,this._first=-1,this._last=-1,this._sizeDim="height",this._secondarySizeDim="width",this._positionDim="top",this._secondaryPositionDim="left",this._scrollPosition=0,this._scrollError=0,this._items=[],this._scrollSize=1,this._overhang=1e3,this._hostSink=t,Promise.resolve().then(()=>this.config=e||this._getDefaultConfig())}set config(t){Object.assign(this,Object.assign({},this._getDefaultConfig(),t))}get config(){return{direction:this.direction}}get items(){return this._items}set items(t){this._setItems(t)}_setItems(t){t!==this._items&&(this._items=t,this._scheduleReflow())}get direction(){return this._direction}set direction(t){t=t==="horizontal"?t:"vertical",t!==this._direction&&(this._direction=t,this._sizeDim=t==="horizontal"?"width":"height",this._secondarySizeDim=t==="horizontal"?"height":"width",this._positionDim=t==="horizontal"?"left":"top",this._secondaryPositionDim=t==="horizontal"?"top":"left",this._triggerReflow())}get viewportSize(){return this._viewportSize}set viewportSize(t){let{_viewDim1:e,_viewDim2:a}=this;Object.assign(this._viewportSize,t),a!==this._viewDim2?this._scheduleLayoutUpdate():e!==this._viewDim1&&this._checkThresholds()}get viewportScroll(){return this._latestCoords}set viewportScroll(t){Object.assign(this._latestCoords,t);let e=this._scrollPosition;this._scrollPosition=this._latestCoords[this._positionDim],Math.abs(e-this._scrollPosition)>=1&&this._checkThresholds()}reflowIfNeeded(t=!1){(t||this._pendingReflow)&&(this._pendingReflow=!1,this._reflow())}set pin(t){this._pin=t,this._triggerReflow()}get pin(){if(this._pin!==null){let{index:t,block:e}=this._pin;return{index:Math.max(0,Math.min(t,this.items.length-1)),block:e}}return null}_clampScrollPosition(t){return Math.max(-this.offsetWithinScroller[this._positionDim],Math.min(t,this.totalScrollSize[Ye(this.direction)]-this._viewDim1))}unpin(){this._pin!==null&&(this._sendUnpinnedMessage(),this._pin=null)}_updateLayout(){}get _viewDim1(){return this._viewportSize[this._sizeDim]}get _viewDim2(){return this._viewportSize[this._secondarySizeDim]}_scheduleReflow(){this._pendingReflow=!0}_scheduleLayoutUpdate(){this._pendingLayoutUpdate=!0,this._scheduleReflow()}_triggerReflow(){this._scheduleLayoutUpdate(),Promise.resolve().then(()=>this.reflowIfNeeded())}_reflow(){this._pendingLayoutUpdate&&(this._updateLayout(),this._pendingLayoutUpdate=!1),this._updateScrollSize(),this._setPositionFromPin(),this._getActiveItems(),this._updateVisibleIndices(),this._sendStateChangedMessage()}_setPositionFromPin(){if(this.pin!==null){let t=this._scrollPosition,{index:e,block:a}=this.pin;this._scrollPosition=this._calculateScrollIntoViewPosition({index:e,block:a||"start"})-this.offsetWithinScroller[this._positionDim],this._scrollError=t-this._scrollPosition}}_calculateScrollIntoViewPosition(t){let{block:e}=t,a=Math.min(this.items.length,Math.max(0,t.index)),o=this._getItemPosition(a)[this._positionDim],i=o;if(e!=="start"){let n=this._getItemSize(a)[this._sizeDim];if(e==="center")i=o-.5*this._viewDim1+.5*n;else{let h=o-this._viewDim1+n;if(e==="end")i=h;else{let s=this._scrollPosition;i=Math.abs(s-o)<Math.abs(s-h)?o:h}}}return i+=this.offsetWithinScroller[this._positionDim],this._clampScrollPosition(i)}getScrollIntoViewCoordinates(t){return{[this._positionDim]:this._calculateScrollIntoViewPosition(t)}}_sendUnpinnedMessage(){this._hostSink({type:"unpinned"})}_sendVisibilityChangedMessage(){this._hostSink({type:"visibilityChanged",firstVisible:this._firstVisible,lastVisible:this._lastVisible})}_sendStateChangedMessage(){let t=new Map;if(this._first!==-1&&this._last!==-1)for(let a=this._first;a<=this._last;a++)t.set(a,this._getItemPosition(a));let e={type:"stateChanged",scrollSize:{[this._sizeDim]:this._scrollSize,[this._secondarySizeDim]:null},range:{first:this._first,last:this._last,firstVisible:this._firstVisible,lastVisible:this._lastVisible},childPositions:t};this._scrollError&&(e.scrollError={[this._positionDim]:this._scrollError,[this._secondaryPositionDim]:0},this._scrollError=0),this._hostSink(e)}get _num(){return this._first===-1||this._last===-1?0:this._last-this._first+1}_checkThresholds(){if(this._viewDim1===0&&this._num>0||this._pin!==null)this._scheduleReflow();else{let t=Math.max(0,this._scrollPosition-this._overhang),e=Math.min(this._scrollSize,this._scrollPosition+this._viewDim1+this._overhang);this._physicalMin>t||this._physicalMax<e?this._scheduleReflow():this._updateVisibleIndices({emit:!0})}}_updateVisibleIndices(t){if(this._first===-1||this._last===-1)return;let e=this._first;for(;e<this._last&&Math.round(this._getItemPosition(e)[this._positionDim]+this._getItemSize(e)[this._sizeDim])<=Math.round(this._scrollPosition);)e++;let a=this._last;for(;a>this._first&&Math.round(this._getItemPosition(a)[this._positionDim])>=Math.round(this._scrollPosition+this._viewDim1);)a--;(e!==this._firstVisible||a!==this._lastVisible)&&(this._firstVisible=e,this._lastVisible=a,t&&t.emit&&this._sendVisibilityChangedMessage())}}});var Jr={};ya(Jr,{FlowLayout:()=>fe,flow:()=>ho});function Kr(r){return r==="horizontal"?"marginLeft":"marginTop"}function go(r){return r==="horizontal"?"marginRight":"marginBottom"}function po(r){return r==="horizontal"?"xOffset":"yOffset"}function fo(r,t){let e=[r,t].sort();return e[1]<=0?Math.min(...e):e[0]>=0?Math.max(...e):e[0]+e[1]}var ho,Qe,fe,Yr=Ee(()=>{Fr();Gr();ho=r=>Object.assign({type:fe},r);Qe=class{constructor(){this._childSizeCache=new Pt,this._marginSizeCache=new Pt,this._metricsCache=new Map}update(t,e){let a=new Set;Object.keys(t).forEach(o=>{let i=Number(o);this._metricsCache.set(i,t[i]),this._childSizeCache.set(i,t[i][Ye(e)]),a.add(i),a.add(i+1)});for(let o of a){let i=this._metricsCache.get(o)?.[Kr(e)]||0,n=this._metricsCache.get(o-1)?.[go(e)]||0;this._marginSizeCache.set(o,fo(i,n))}}get averageChildSize(){return this._childSizeCache.averageSize}get totalChildSize(){return this._childSizeCache.totalSize}get averageMarginSize(){return this._marginSizeCache.averageSize}get totalMarginSize(){return this._marginSizeCache.totalSize}getLeadingMarginValue(t,e){return this._metricsCache.get(t)?.[Kr(e)]||0}getChildSize(t){return this._childSizeCache.getSize(t)}getMarginSize(t){return this._marginSizeCache.getSize(t)}clear(){this._childSizeCache.clear(),this._marginSizeCache.clear(),this._metricsCache.clear()}},fe=class extends pe{constructor(){super(...arguments),this._itemSize={width:100,height:100},this._physicalItems=new Map,this._newPhysicalItems=new Map,this._metricsCache=new Qe,this._anchorIdx=null,this._anchorPos=null,this._stable=!0,this._measureChildren=!0,this._estimate=!0}get measureChildren(){return this._measureChildren}updateItemSizes(t){this._metricsCache.update(t,this.direction),this._scheduleReflow()}_getPhysicalItem(t){return this._newPhysicalItems.get(t)??this._physicalItems.get(t)}_getSize(t){return this._getPhysicalItem(t)&&this._metricsCache.getChildSize(t)}_getAverageSize(){return this._metricsCache.averageChildSize||this._itemSize[this._sizeDim]}_estimatePosition(t){let e=this._metricsCache;if(this._first===-1||this._last===-1)return e.averageMarginSize+t*(e.averageMarginSize+this._getAverageSize());if(t<this._first){let a=this._first-t;return this._getPhysicalItem(this._first).pos-(e.getMarginSize(this._first-1)||e.averageMarginSize)-(a*e.averageChildSize+(a-1)*e.averageMarginSize)}else{let a=t-this._last;return this._getPhysicalItem(this._last).pos+(e.getChildSize(this._last)||e.averageChildSize)+(e.getMarginSize(this._last)||e.averageMarginSize)+a*(e.averageChildSize+e.averageMarginSize)}}_getPosition(t){let e=this._getPhysicalItem(t),{averageMarginSize:a}=this._metricsCache;return t===0?this._metricsCache.getMarginSize(0)??a:e?e.pos:this._estimatePosition(t)}_calculateAnchor(t,e){return t<=0?0:e>this._scrollSize-this._viewDim1?this.items.length-1:Math.max(0,Math.min(this.items.length-1,Math.floor((t+e)/2/this._delta)))}_getAnchor(t,e){if(this._physicalItems.size===0)return this._calculateAnchor(t,e);if(this._first<0)return this._calculateAnchor(t,e);if(this._last<0)return this._calculateAnchor(t,e);let a=this._getPhysicalItem(this._first),o=this._getPhysicalItem(this._last),i=a.pos;if(o.pos+this._metricsCache.getChildSize(this._last)<t)return this._calculateAnchor(t,e);if(i>e)return this._calculateAnchor(t,e);let s=this._firstVisible-1,c=-1/0;for(;c<t;)c=this._getPhysicalItem(++s).pos+this._metricsCache.getChildSize(s);return s}_getActiveItems(){this._viewDim1===0||this.items.length===0?this._clearItems():this._getItems()}_clearItems(){this._first=-1,this._last=-1,this._physicalMin=0,this._physicalMax=0;let t=this._newPhysicalItems;this._newPhysicalItems=this._physicalItems,this._newPhysicalItems.clear(),this._physicalItems=t,this._stable=!0}_getItems(){let t=this._newPhysicalItems;this._stable=!0;let e,a;if(this.pin!==null){let{index:c}=this.pin;this._anchorIdx=c,this._anchorPos=this._getPosition(c)}if(e=this._scrollPosition-this._overhang,a=this._scrollPosition+this._viewDim1+this._overhang,a<0||e>this._scrollSize){this._clearItems();return}(this._anchorIdx===null||this._anchorPos===null)&&(this._anchorIdx=this._getAnchor(e,a),this._anchorPos=this._getPosition(this._anchorIdx));let o=this._getSize(this._anchorIdx);o===void 0&&(this._stable=!1,o=this._getAverageSize());let i=this._metricsCache.getMarginSize(this._anchorIdx)??this._metricsCache.averageMarginSize,n=this._metricsCache.getMarginSize(this._anchorIdx+1)??this._metricsCache.averageMarginSize;this._anchorIdx===0&&(this._anchorPos=i),this._anchorIdx===this.items.length-1&&(this._anchorPos=this._scrollSize-n-o);let h=0;for(this._anchorPos+o+n<e&&(h=e-(this._anchorPos+o+n)),this._anchorPos-i>a&&(h=a-(this._anchorPos-i)),h&&(this._scrollPosition-=h,e-=h,a-=h,this._scrollError+=h),t.set(this._anchorIdx,{pos:this._anchorPos,size:o}),this._first=this._last=this._anchorIdx,this._physicalMin=this._anchorPos-i,this._physicalMax=this._anchorPos+o+n;this._physicalMin>e&&this._first>0;){let c=this._getSize(--this._first);c===void 0&&(this._stable=!1,c=this._getAverageSize());let p=this._metricsCache.getMarginSize(this._first);p===void 0&&(this._stable=!1,p=this._metricsCache.averageMarginSize),this._physicalMin-=c;let l=this._physicalMin;if(t.set(this._first,{pos:l,size:c}),this._physicalMin-=p,this._stable===!1&&this._estimate===!1)break}for(;this._physicalMax<a&&this._last<this.items.length-1;){let c=this._getSize(++this._last);c===void 0&&(this._stable=!1,c=this._getAverageSize());let p=this._metricsCache.getMarginSize(this._last);p===void 0&&(this._stable=!1,p=this._metricsCache.averageMarginSize);let l=this._physicalMax;if(t.set(this._last,{pos:l,size:c}),this._physicalMax+=c+p,!this._stable&&!this._estimate)break}let s=this._calculateError();s&&(this._physicalMin-=s,this._physicalMax-=s,this._anchorPos-=s,this._scrollPosition-=s,t.forEach(c=>c.pos-=s),this._scrollError+=s),this._stable&&(this._newPhysicalItems=this._physicalItems,this._newPhysicalItems.clear(),this._physicalItems=t)}_calculateError(){return this._first===0?this._physicalMin:this._physicalMin<=0?this._physicalMin-this._first*this._delta:this._last===this.items.length-1?this._physicalMax-this._scrollSize:this._physicalMax>=this._scrollSize?this._physicalMax-this._scrollSize+(this.items.length-1-this._last)*this._delta:0}_reflow(){let{_first:t,_last:e}=this;super._reflow(),(this._first===-1&&this._last==-1||this._first===t&&this._last===e)&&this._resetReflowState()}_resetReflowState(){this._anchorIdx=null,this._anchorPos=null,this._stable=!0}_updateScrollSize(){let{averageMarginSize:t}=this._metricsCache;this._scrollSize=Math.max(1,this.items.length*(t+this._getAverageSize())+t)}get _delta(){let{averageMarginSize:t}=this._metricsCache;return this._getAverageSize()+t}_getItemPosition(t){return{[this._positionDim]:this._getPosition(t),[this._secondaryPositionDim]:0,[po(this.direction)]:-(this._metricsCache.getLeadingMarginValue(t,this.direction)??this._metricsCache.averageMarginSize)}}_getItemSize(t){return{[this._sizeDim]:this._getSize(t)||this._getAverageSize(),[this._secondarySizeDim]:this._itemSize[this._secondarySizeDim]}}_viewDim2Changed(){this._metricsCache.clear(),this._scheduleReflow()}}});var Bt=globalThis,Ft=Bt.ShadowRoot&&(Bt.ShadyCSS===void 0||Bt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ce=Symbol(),hr=new WeakMap,bt=class{constructor(t,e,a){if(this._$cssResult$=!0,a!==Ce)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(Ft&&t===void 0){let a=e!==void 0&&e.length===1;a&&(t=hr.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),a&&hr.set(e,t))}return t}toString(){return this.cssText}},Gt=r=>new bt(typeof r=="string"?r:r+"",void 0,Ce),m=(r,...t)=>{let e=r.length===1?r[0]:t.reduce(((a,o,i)=>a+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+r[i+1]),r[0]);return new bt(e,r,Ce)},dr=(r,t)=>{if(Ft)r.adoptedStyleSheets=t.map((e=>e instanceof CSSStyleSheet?e:e.styleSheet));else for(let e of t){let a=document.createElement("style"),o=Bt.litNonce;o!==void 0&&a.setAttribute("nonce",o),a.textContent=e.cssText,r.appendChild(a)}},Ae=Ft?r=>r:r=>r instanceof CSSStyleSheet?(t=>{let e="";for(let a of t.cssRules)e+=a.cssText;return Gt(e)})(r):r;var{is:ka,defineProperty:_a,getOwnPropertyDescriptor:wa,getOwnPropertyNames:xa,getOwnPropertySymbols:Sa,getPrototypeOf:$a}=Object,Kt=globalThis,gr=Kt.trustedTypes,Ea=gr?gr.emptyScript:"",Ca=Kt.reactiveElementPolyfillSupport,vt=(r,t)=>r,yt={toAttribute(r,t){switch(t){case Boolean:r=r?Ea:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,t){let e=r;switch(t){case Boolean:e=r!==null;break;case Number:e=r===null?null:Number(r);break;case Object:case Array:try{e=JSON.parse(r)}catch{e=null}}return e}},Jt=(r,t)=>!ka(r,t),pr={attribute:!0,type:String,converter:yt,reflect:!1,useDefault:!1,hasChanged:Jt};Symbol.metadata??=Symbol("metadata"),Kt.litPropertyMetadata??=new WeakMap;var V=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=pr){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let a=Symbol(),o=this.getPropertyDescriptor(t,a,e);o!==void 0&&_a(this.prototype,t,o)}}static getPropertyDescriptor(t,e,a){let{get:o,set:i}=wa(this.prototype,t)??{get(){return this[e]},set(n){this[e]=n}};return{get:o,set(n){let h=o?.call(this);i?.call(this,n),this.requestUpdate(t,h,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??pr}static _$Ei(){if(this.hasOwnProperty(vt("elementProperties")))return;let t=$a(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(vt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(vt("properties"))){let e=this.properties,a=[...xa(e),...Sa(e)];for(let o of a)this.createProperty(o,e[o])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[a,o]of e)this.elementProperties.set(a,o)}this._$Eh=new Map;for(let[e,a]of this.elementProperties){let o=this._$Eu(e,a);o!==void 0&&this._$Eh.set(o,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let a=new Set(t.flat(1/0).reverse());for(let o of a)e.unshift(Ae(o))}else t!==void 0&&e.push(Ae(t));return e}static _$Eu(t,e){let a=e.attribute;return a===!1?void 0:typeof a=="string"?a:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((t=>t(this)))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,e=this.constructor.elementProperties;for(let a of e.keys())this.hasOwnProperty(a)&&(t.set(a,this[a]),delete this[a]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return dr(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((t=>t.hostConnected?.()))}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach((t=>t.hostDisconnected?.()))}attributeChangedCallback(t,e,a){this._$AK(t,a)}_$ET(t,e){let a=this.constructor.elementProperties.get(t),o=this.constructor._$Eu(t,a);if(o!==void 0&&a.reflect===!0){let i=(a.converter?.toAttribute!==void 0?a.converter:yt).toAttribute(e,a.type);this._$Em=t,i==null?this.removeAttribute(o):this.setAttribute(o,i),this._$Em=null}}_$AK(t,e){let a=this.constructor,o=a._$Eh.get(t);if(o!==void 0&&this._$Em!==o){let i=a.getPropertyOptions(o),n=typeof i.converter=="function"?{fromAttribute:i.converter}:i.converter?.fromAttribute!==void 0?i.converter:yt;this._$Em=o;let h=n.fromAttribute(e,i.type);this[o]=h??this._$Ej?.get(o)??h,this._$Em=null}}requestUpdate(t,e,a){if(t!==void 0){let o=this.constructor,i=this[t];if(a??=o.getPropertyOptions(t),!((a.hasChanged??Jt)(i,e)||a.useDefault&&a.reflect&&i===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,a))))return;this.C(t,e,a)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:a,reflect:o,wrapped:i},n){a&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,n??e??this[t]),i!==!0||n!==void 0)||(this._$AL.has(t)||(this.hasUpdated||a||(e=void 0),this._$AL.set(t,e)),o===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[o,i]of this._$Ep)this[o]=i;this._$Ep=void 0}let a=this.constructor.elementProperties;if(a.size>0)for(let[o,i]of a){let{wrapped:n}=i,h=this[o];n!==!0||this._$AL.has(o)||h===void 0||this.C(o,void 0,i,h)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach((a=>a.hostUpdate?.())),this.update(e)):this._$EM()}catch(a){throw t=!1,this._$EM(),a}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach((e=>e.hostUpdated?.())),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach((e=>this._$ET(e,this[e]))),this._$EM()}updated(t){}firstUpdated(t){}};V.elementStyles=[],V.shadowRootOptions={mode:"open"},V[vt("elementProperties")]=new Map,V[vt("finalized")]=new Map,Ca?.({ReactiveElement:V}),(Kt.reactiveElementVersions??=[]).push("2.1.1");var Pe=globalThis,Yt=Pe.trustedTypes,fr=Yt?Yt.createPolicy("lit-html",{createHTML:r=>r}):void 0,ze="$lit$",B=`lit$${Math.random().toFixed(9).slice(2)}$`,Le="?"+B,Aa=`<${Le}>`,Z=document,_t=()=>Z.createComment(""),wt=r=>r===null||typeof r!="object"&&typeof r!="function",Re=Array.isArray,kr=r=>Re(r)||typeof r?.[Symbol.iterator]=="function",Te=`[ 	
\f\r]`,kt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ur=/-->/g,mr=/>/g,Y=RegExp(`>|${Te}(?:([^\\s"'>=/]+)(${Te}*=${Te}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),br=/'/g,vr=/"/g,_r=/^(?:script|style|textarea|title)$/i,Me=r=>(t,...e)=>({_$litType$:r,strings:t,values:e}),g=Me(1),wr=Me(2),ai=Me(3),P=Symbol.for("lit-noChange"),w=Symbol.for("lit-nothing"),yr=new WeakMap,Q=Z.createTreeWalker(Z,129);function xr(r,t){if(!Re(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return fr!==void 0?fr.createHTML(t):t}var Sr=(r,t)=>{let e=r.length-1,a=[],o,i=t===2?"<svg>":t===3?"<math>":"",n=kt;for(let h=0;h<e;h++){let s=r[h],c,p,l=-1,k=0;for(;k<s.length&&(n.lastIndex=k,p=n.exec(s),p!==null);)k=n.lastIndex,n===kt?p[1]==="!--"?n=ur:p[1]!==void 0?n=mr:p[2]!==void 0?(_r.test(p[2])&&(o=RegExp("</"+p[2],"g")),n=Y):p[3]!==void 0&&(n=Y):n===Y?p[0]===">"?(n=o??kt,l=-1):p[1]===void 0?l=-2:(l=n.lastIndex-p[2].length,c=p[1],n=p[3]===void 0?Y:p[3]==='"'?vr:br):n===vr||n===br?n=Y:n===ur||n===mr?n=kt:(n=Y,o=void 0);let f=n===Y&&r[h+1].startsWith("/>")?" ":"";i+=n===kt?s+Aa:l>=0?(a.push(c),s.slice(0,l)+ze+s.slice(l)+B+f):s+B+(l===-2?h:f)}return[xr(r,i+(r[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),a]},xt=class r{constructor({strings:t,_$litType$:e},a){let o;this.parts=[];let i=0,n=0,h=t.length-1,s=this.parts,[c,p]=Sr(t,e);if(this.el=r.createElement(c,a),Q.currentNode=this.el.content,e===2||e===3){let l=this.el.content.firstChild;l.replaceWith(...l.childNodes)}for(;(o=Q.nextNode())!==null&&s.length<h;){if(o.nodeType===1){if(o.hasAttributes())for(let l of o.getAttributeNames())if(l.endsWith(ze)){let k=p[n++],f=o.getAttribute(l).split(B),v=/([.?@])?(.*)/.exec(k);s.push({type:1,index:i,name:v[2],strings:f,ctor:v[1]==="."?Zt:v[1]==="?"?Xt:v[1]==="@"?te:tt}),o.removeAttribute(l)}else l.startsWith(B)&&(s.push({type:6,index:i}),o.removeAttribute(l));if(_r.test(o.tagName)){let l=o.textContent.split(B),k=l.length-1;if(k>0){o.textContent=Yt?Yt.emptyScript:"";for(let f=0;f<k;f++)o.append(l[f],_t()),Q.nextNode(),s.push({type:2,index:++i});o.append(l[k],_t())}}}else if(o.nodeType===8)if(o.data===Le)s.push({type:2,index:i});else{let l=-1;for(;(l=o.data.indexOf(B,l+1))!==-1;)s.push({type:7,index:i}),l+=B.length-1}i++}}static createElement(t,e){let a=Z.createElement("template");return a.innerHTML=t,a}};function X(r,t,e=r,a){if(t===P)return t;let o=a!==void 0?e._$Co?.[a]:e._$Cl,i=wt(t)?void 0:t._$litDirective$;return o?.constructor!==i&&(o?._$AO?.(!1),i===void 0?o=void 0:(o=new i(r),o._$AT(r,e,a)),a!==void 0?(e._$Co??=[])[a]=o:e._$Cl=o),o!==void 0&&(t=X(r,o._$AS(r,t.values),o,a)),t}var Qt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:a}=this._$AD,o=(t?.creationScope??Z).importNode(e,!0);Q.currentNode=o;let i=Q.nextNode(),n=0,h=0,s=a[0];for(;s!==void 0;){if(n===s.index){let c;s.type===2?c=new st(i,i.nextSibling,this,t):s.type===1?c=new s.ctor(i,s.name,s.strings,this,t):s.type===6&&(c=new ee(i,this,t)),this._$AV.push(c),s=a[++h]}n!==s?.index&&(i=Q.nextNode(),n++)}return Q.currentNode=Z,o}p(t){let e=0;for(let a of this._$AV)a!==void 0&&(a.strings!==void 0?(a._$AI(t,a,e),e+=a.strings.length-2):a._$AI(t[e])),e++}},st=class r{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,a,o){this.type=2,this._$AH=w,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=a,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=X(this,t,e),wt(t)?t===w||t==null||t===""?(this._$AH!==w&&this._$AR(),this._$AH=w):t!==this._$AH&&t!==P&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):kr(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==w&&wt(this._$AH)?this._$AA.nextSibling.data=t:this.T(Z.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:a}=t,o=typeof a=="number"?this._$AC(t):(a.el===void 0&&(a.el=xt.createElement(xr(a.h,a.h[0]),this.options)),a);if(this._$AH?._$AD===o)this._$AH.p(e);else{let i=new Qt(o,this),n=i.u(this.options);i.p(e),this.T(n),this._$AH=i}}_$AC(t){let e=yr.get(t.strings);return e===void 0&&yr.set(t.strings,e=new xt(t)),e}k(t){Re(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,a,o=0;for(let i of t)o===e.length?e.push(a=new r(this.O(_t()),this.O(_t()),this,this.options)):a=e[o],a._$AI(i),o++;o<e.length&&(this._$AR(a&&a._$AB.nextSibling,o),e.length=o)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let a=t.nextSibling;t.remove(),t=a}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},tt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,a,o,i){this.type=1,this._$AH=w,this._$AN=void 0,this.element=t,this.name=e,this._$AM=o,this.options=i,a.length>2||a[0]!==""||a[1]!==""?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=w}_$AI(t,e=this,a,o){let i=this.strings,n=!1;if(i===void 0)t=X(this,t,e,0),n=!wt(t)||t!==this._$AH&&t!==P,n&&(this._$AH=t);else{let h=t,s,c;for(t=i[0],s=0;s<i.length-1;s++)c=X(this,h[a+s],e,s),c===P&&(c=this._$AH[s]),n||=!wt(c)||c!==this._$AH[s],c===w?t=w:t!==w&&(t+=(c??"")+i[s+1]),this._$AH[s]=c}n&&!o&&this.j(t)}j(t){t===w?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Zt=class extends tt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===w?void 0:t}},Xt=class extends tt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==w)}},te=class extends tt{constructor(t,e,a,o,i){super(t,e,a,o,i),this.type=5}_$AI(t,e=this){if((t=X(this,t,e,0)??w)===P)return;let a=this._$AH,o=t===w&&a!==w||t.capture!==a.capture||t.once!==a.once||t.passive!==a.passive,i=t!==w&&(a===w||o);o&&this.element.removeEventListener(this.name,this,a),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},ee=class{constructor(t,e,a){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(t){X(this,t)}},$r={M:ze,P:B,A:Le,C:1,L:Sr,R:Qt,D:kr,V:X,I:st,H:tt,N:Xt,U:te,B:Zt,F:ee},Ta=Pe.litHtmlPolyfillSupport;Ta?.(xt,st),(Pe.litHtmlVersions??=[]).push("3.3.1");var Er=(r,t,e)=>{let a=e?.renderBefore??t,o=a._$litPart$;if(o===void 0){let i=e?.renderBefore??null;a._$litPart$=o=new st(t.insertBefore(_t(),i),i,void 0,e??{})}return o._$AI(r),o};var Ie=globalThis,b=class extends V{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Er(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return P}};b._$litElement$=!0,b.finalized=!0,Ie.litElementHydrateSupport?.({LitElement:b});var Pa=Ie.litElementPolyfillSupport;Pa?.({LitElement:b});(Ie.litElementVersions??=[]).push("4.2.1");var _=r=>(t,e)=>{e!==void 0?e.addInitializer((()=>{customElements.define(r,t)})):customElements.define(r,t)};var za={attribute:!0,type:String,converter:yt,reflect:!1,hasChanged:Jt},La=(r=za,t,e)=>{let{kind:a,metadata:o}=e,i=globalThis.litPropertyMetadata.get(o);if(i===void 0&&globalThis.litPropertyMetadata.set(o,i=new Map),a==="setter"&&((r=Object.create(r)).wrapped=!0),i.set(e.name,r),a==="accessor"){let{name:n}=e;return{set(h){let s=t.get.call(this);t.set.call(this,h),this.requestUpdate(n,s,r)},init(h){return h!==void 0&&this.C(n,void 0,r,h),h}}}if(a==="setter"){let{name:n}=e;return function(h){let s=this[n];t.call(this,h),this.requestUpdate(n,s,r)}}throw Error("Unsupported decorator location: "+a)};function u(r){return(t,e)=>typeof e=="object"?La(r,t,e):((a,o,i)=>{let n=o.hasOwnProperty(i);return o.constructor.createProperty(i,a),n?Object.getOwnPropertyDescriptor(o,i):void 0})(r,t,e)}function T(r){return u({...r,state:!0,attribute:!1})}var Ra=Object.defineProperty,Ma=(r,t,e)=>t in r?Ra(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e,Oe=(r,t,e)=>(Ma(r,typeof t!="symbol"?t+"":t,e),e),Ia=(r,t,e)=>{if(!t.has(r))throw TypeError("Cannot "+e)},Ne=(r,t)=>{if(Object(t)!==t)throw TypeError('Cannot use the "in" operator on this value');return r.has(t)},ae=(r,t,e)=>{if(t.has(r))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(r):t.set(r,e)},Cr=(r,t,e)=>(Ia(r,t,"access private method"),e);function Ar(r,t){return Object.is(r,t)}var E=null,St=!1,oe=1,ie=Symbol("SIGNAL");function lt(r){let t=E;return E=r,t}function Oa(){return E}function Na(){return St}var He={version:0,lastCleanEpoch:0,dirty:!1,producerNode:void 0,producerLastReadVersion:void 0,producerIndexOfThis:void 0,nextProducerIndex:0,liveConsumerNode:void 0,liveConsumerIndexOfThis:void 0,consumerAllowSignalWrites:!1,consumerIsAlwaysLive:!1,producerMustRecompute:()=>!1,producerRecomputeValue:()=>{},consumerMarkedDirty:()=>{},consumerOnSignalRead:()=>{}};function ne(r){if(St)throw new Error(typeof ngDevMode<"u"&&ngDevMode?"Assertion error: signal read during notification phase":"");if(E===null)return;E.consumerOnSignalRead(r);let t=E.nextProducerIndex++;if(ct(E),t<E.producerNode.length&&E.producerNode[t]!==r&&je(E)){let e=E.producerNode[t];se(e,E.producerIndexOfThis[t])}E.producerNode[t]!==r&&(E.producerNode[t]=r,E.producerIndexOfThis[t]=je(E)?zr(r,E,t):0),E.producerLastReadVersion[t]=r.version}function Ua(){oe++}function Tr(r){if(!(!r.dirty&&r.lastCleanEpoch===oe)){if(!r.producerMustRecompute(r)&&!Wa(r)){r.dirty=!1,r.lastCleanEpoch=oe;return}r.producerRecomputeValue(r),r.dirty=!1,r.lastCleanEpoch=oe}}function Pr(r){if(r.liveConsumerNode===void 0)return;let t=St;St=!0;try{for(let e of r.liveConsumerNode)e.dirty||ja(e)}finally{St=t}}function Da(){return E?.consumerAllowSignalWrites!==!1}function ja(r){var t;r.dirty=!0,Pr(r),(t=r.consumerMarkedDirty)==null||t.call(r.wrapper??r)}function qa(r){return r&&(r.nextProducerIndex=0),lt(r)}function Ha(r,t){if(lt(t),!(!r||r.producerNode===void 0||r.producerIndexOfThis===void 0||r.producerLastReadVersion===void 0)){if(je(r))for(let e=r.nextProducerIndex;e<r.producerNode.length;e++)se(r.producerNode[e],r.producerIndexOfThis[e]);for(;r.producerNode.length>r.nextProducerIndex;)r.producerNode.pop(),r.producerLastReadVersion.pop(),r.producerIndexOfThis.pop()}}function Wa(r){ct(r);for(let t=0;t<r.producerNode.length;t++){let e=r.producerNode[t],a=r.producerLastReadVersion[t];if(a!==e.version||(Tr(e),a!==e.version))return!0}return!1}function zr(r,t,e){var a;if(We(r),ct(r),r.liveConsumerNode.length===0){(a=r.watched)==null||a.call(r.wrapper);for(let o=0;o<r.producerNode.length;o++)r.producerIndexOfThis[o]=zr(r.producerNode[o],r,o)}return r.liveConsumerIndexOfThis.push(e),r.liveConsumerNode.push(t)-1}function se(r,t){var e;if(We(r),ct(r),typeof ngDevMode<"u"&&ngDevMode&&t>=r.liveConsumerNode.length)throw new Error(`Assertion error: active consumer index ${t} is out of bounds of ${r.liveConsumerNode.length} consumers)`);if(r.liveConsumerNode.length===1){(e=r.unwatched)==null||e.call(r.wrapper);for(let o=0;o<r.producerNode.length;o++)se(r.producerNode[o],r.producerIndexOfThis[o])}let a=r.liveConsumerNode.length-1;if(r.liveConsumerNode[t]=r.liveConsumerNode[a],r.liveConsumerIndexOfThis[t]=r.liveConsumerIndexOfThis[a],r.liveConsumerNode.length--,r.liveConsumerIndexOfThis.length--,t<r.liveConsumerNode.length){let o=r.liveConsumerIndexOfThis[t],i=r.liveConsumerNode[t];ct(i),i.producerIndexOfThis[o]=t}}function je(r){var t;return r.consumerIsAlwaysLive||(((t=r?.liveConsumerNode)==null?void 0:t.length)??0)>0}function ct(r){r.producerNode??(r.producerNode=[]),r.producerIndexOfThis??(r.producerIndexOfThis=[]),r.producerLastReadVersion??(r.producerLastReadVersion=[])}function We(r){r.liveConsumerNode??(r.liveConsumerNode=[]),r.liveConsumerIndexOfThis??(r.liveConsumerIndexOfThis=[])}function Lr(r){if(Tr(r),ne(r),r.value===qe)throw r.error;return r.value}function Va(r){let t=Object.create(Ba);t.computation=r;let e=()=>Lr(t);return e[ie]=t,e}var Ue=Symbol("UNSET"),De=Symbol("COMPUTING"),qe=Symbol("ERRORED"),Ba={...He,value:Ue,dirty:!0,error:null,equal:Ar,producerMustRecompute(r){return r.value===Ue||r.value===De},producerRecomputeValue(r){if(r.value===De)throw new Error("Detected cycle in computations.");let t=r.value;r.value=De;let e=qa(r),a,o=!1;try{a=r.computation.call(r.wrapper),o=t!==Ue&&t!==qe&&r.equal.call(r.wrapper,t,a)}catch(i){a=qe,r.error=i}finally{Ha(r,e)}if(o){r.value=t;return}r.value=a,r.version++}};function Fa(){throw new Error}var Ga=Fa;function Ka(){Ga()}function Ja(r){let t=Object.create(Za);t.value=r;let e=()=>(ne(t),t.value);return e[ie]=t,e}function Ya(){return ne(this),this.value}function Qa(r,t){Da()||Ka(),r.equal.call(r.wrapper,r.value,t)||(r.value=t,Xa(r))}var Za={...He,equal:Ar,value:void 0};function Xa(r){r.version++,Ua(),Pr(r)}var A=Symbol("node"),S;(r=>{var t,e,a,o,i,n;class h{constructor(p,l={}){ae(this,e),Oe(this,t);let f=Ja(p)[ie];if(this[A]=f,f.wrapper=this,l){let v=l.equals;v&&(f.equal=v),f.watched=l[r.subtle.watched],f.unwatched=l[r.subtle.unwatched]}}get(){if(!(0,r.isState)(this))throw new TypeError("Wrong receiver type for Signal.State.prototype.get");return Ya.call(this[A])}set(p){if(!(0,r.isState)(this))throw new TypeError("Wrong receiver type for Signal.State.prototype.set");if(Na())throw new Error("Writes to signals not permitted during Watcher callback");let l=this[A];Qa(l,p)}}t=A,e=new WeakSet,a=function(){},r.isState=c=>typeof c=="object"&&Ne(e,c),r.State=h;class s{constructor(p,l){ae(this,i),Oe(this,o);let f=Va(p)[ie];if(f.consumerAllowSignalWrites=!0,this[A]=f,f.wrapper=this,l){let v=l.equals;v&&(f.equal=v),f.watched=l[r.subtle.watched],f.unwatched=l[r.subtle.unwatched]}}get(){if(!(0,r.isComputed)(this))throw new TypeError("Wrong receiver type for Signal.Computed.prototype.get");return Lr(this[A])}}o=A,i=new WeakSet,n=function(){},r.isComputed=c=>typeof c=="object"&&Ne(i,c),r.Computed=s,(c=>{var p,l,k,f,v;function C($){let x,y=null;try{y=lt(null),x=$()}finally{lt(y)}return x}c.untrack=C;function W($){var x;if(!(0,r.isComputed)($)&&!(0,r.isWatcher)($))throw new TypeError("Called introspectSources without a Computed or Watcher argument");return((x=$[A].producerNode)==null?void 0:x.map(y=>y.wrapper))??[]}c.introspectSources=W;function R($){var x;if(!(0,r.isComputed)($)&&!(0,r.isState)($))throw new TypeError("Called introspectSinks without a Signal argument");return((x=$[A].liveConsumerNode)==null?void 0:x.map(y=>y.wrapper))??[]}c.introspectSinks=R;function $e($){if(!(0,r.isComputed)($)&&!(0,r.isState)($))throw new TypeError("Called hasSinks without a Signal argument");let x=$[A].liveConsumerNode;return x?x.length>0:!1}c.hasSinks=$e;function fa($){if(!(0,r.isComputed)($)&&!(0,r.isWatcher)($))throw new TypeError("Called hasSources without a Computed or Watcher argument");let x=$[A].producerNode;return x?x.length>0:!1}c.hasSources=fa;class ua{constructor(x){ae(this,l),ae(this,f),Oe(this,p);let y=Object.create(He);y.wrapper=this,y.consumerMarkedDirty=x,y.consumerIsAlwaysLive=!0,y.consumerAllowSignalWrites=!1,y.producerNode=[],this[A]=y}watch(...x){if(!(0,r.isWatcher)(this))throw new TypeError("Called unwatch without Watcher receiver");Cr(this,f,v).call(this,x);let y=this[A];y.dirty=!1;let M=lt(y);for(let Vt of x)ne(Vt[A]);lt(M)}unwatch(...x){if(!(0,r.isWatcher)(this))throw new TypeError("Called unwatch without Watcher receiver");Cr(this,f,v).call(this,x);let y=this[A];ct(y);for(let M=y.producerNode.length-1;M>=0;M--)if(x.includes(y.producerNode[M].wrapper)){se(y.producerNode[M],y.producerIndexOfThis[M]);let Vt=y.producerNode.length-1;if(y.producerNode[M]=y.producerNode[Vt],y.producerIndexOfThis[M]=y.producerIndexOfThis[Vt],y.producerNode.length--,y.producerIndexOfThis.length--,y.nextProducerIndex--,M<y.producerNode.length){let ba=y.producerIndexOfThis[M],lr=y.producerNode[M];We(lr),lr.liveConsumerIndexOfThis[ba]=M}}}getPending(){if(!(0,r.isWatcher)(this))throw new TypeError("Called getPending without Watcher receiver");return this[A].producerNode.filter(y=>y.dirty).map(y=>y.wrapper)}}p=A,l=new WeakSet,k=function(){},f=new WeakSet,v=function($){for(let x of $)if(!(0,r.isComputed)(x)&&!(0,r.isState)(x))throw new TypeError("Called watch/unwatch without a Computed or State argument")},r.isWatcher=$=>Ne(l,$),c.Watcher=ua;function ma(){var $;return($=Oa())==null?void 0:$.wrapper}c.currentComputed=ma,c.watched=Symbol("watched"),c.unwatched=Symbol("unwatched")})(r.subtle||(r.subtle={}))})(S||(S={}));var Ve=!1,Rr=new S.subtle.Watcher(()=>{Ve||(Ve=!0,queueMicrotask(()=>{Ve=!1;for(let r of Rr.getPending())r.get();Rr.watch()}))}),to=Symbol("SignalWatcherBrand"),eo=new FinalizationRegistry(r=>{r.unwatch(...S.subtle.introspectSources(r))}),Mr=new WeakMap;function $t(r){return r[to]===!0?(console.warn("SignalWatcher should not be applied to the same class more than once."),r):class extends r{constructor(){super(...arguments),this._$St=new Map,this._$So=new S.State(0),this._$Si=!1}_$Sl(){var t,e;let a=[],o=[];this._$St.forEach((n,h)=>{(n?.beforeUpdate?a:o).push(h)});let i=(t=this.h)===null||t===void 0?void 0:t.getPending().filter(n=>n!==this._$Su&&!this._$St.has(n));a.forEach(n=>n.get()),(e=this._$Su)===null||e===void 0||e.get(),i.forEach(n=>n.get()),o.forEach(n=>n.get())}_$Sv(){this.isUpdatePending||queueMicrotask(()=>{this.isUpdatePending||this._$Sl()})}_$S_(){if(this.h!==void 0)return;this._$Su=new S.Computed(()=>{this._$So.get(),super.performUpdate()});let t=this.h=new S.subtle.Watcher(function(){let e=Mr.get(this);e!==void 0&&(e._$Si===!1&&(new Set(this.getPending()).has(e._$Su)?e.requestUpdate():e._$Sv()),this.watch())});Mr.set(t,this),eo.register(this,t),t.watch(this._$Su),t.watch(...Array.from(this._$St).map(([e])=>e))}_$Sp(){if(this.h===void 0)return;let t=!1;this.h.unwatch(...S.subtle.introspectSources(this.h).filter(e=>{var a;let o=((a=this._$St.get(e))===null||a===void 0?void 0:a.manualDispose)!==!0;return o&&this._$St.delete(e),t||(t=!o),o})),t||(this._$Su=void 0,this.h=void 0,this._$St.clear())}updateEffect(t,e){var a;this._$S_();let o=new S.Computed(()=>{t()});return this.h.watch(o),this._$St.set(o,e),(a=e?.beforeUpdate)!==null&&a!==void 0&&a?S.subtle.untrack(()=>o.get()):this.updateComplete.then(()=>S.subtle.untrack(()=>o.get())),()=>{this._$St.delete(o),this.h.unwatch(o),this.isConnected===!1&&this._$Sp()}}performUpdate(){this.isUpdatePending&&(this._$S_(),this._$Si=!0,this._$So.set(this._$So.get()+1),this._$Si=!1,this._$Sl())}connectedCallback(){super.connectedCallback(),this.requestUpdate()}disconnectedCallback(){super.disconnectedCallback(),queueMicrotask(()=>{this.isConnected===!1&&this._$Sp()})}}}var D={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},O=r=>(...t)=>({_$litDirective$:r,values:t}),U=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,a){this._$Ct=t,this._$AM=e,this._$Ci=a}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var{I:ro}=$r;var Or=r=>r.strings===void 0,Ir=()=>document.createComment(""),ht=(r,t,e)=>{let a=r._$AA.parentNode,o=t===void 0?r._$AB:t._$AA;if(e===void 0){let i=a.insertBefore(Ir(),o),n=a.insertBefore(Ir(),o);e=new ro(i,n,r,r.options)}else{let i=e._$AB.nextSibling,n=e._$AM,h=n!==r;if(h){let s;e._$AQ?.(r),e._$AM=r,e._$AP!==void 0&&(s=r._$AU)!==n._$AU&&e._$AP(s)}if(i!==o||h){let s=e._$AA;for(;s!==i;){let c=s.nextSibling;a.insertBefore(s,o),s=c}}}return e},K=(r,t,e=r)=>(r._$AI(t,e),r),ao={},Nr=(r,t=ao)=>r._$AH=t,Ur=r=>r._$AH,le=r=>{r._$AR(),r._$AA.remove()};var Et=(r,t)=>{let e=r._$AN;if(e===void 0)return!1;for(let a of e)a._$AO?.(t,!1),Et(a,t);return!0},ce=r=>{let t,e;do{if((t=r._$AM)===void 0)break;e=t._$AN,e.delete(r),r=t}while(e?.size===0)},Dr=r=>{for(let t;t=r._$AM;r=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(r))break;e.add(r),no(t)}};function oo(r){this._$AN!==void 0?(ce(this),this._$AM=r,Dr(this)):this._$AM=r}function io(r,t=!1,e=0){let a=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(t)if(Array.isArray(a))for(let i=e;i<a.length;i++)Et(a[i],!1),ce(a[i]);else a!=null&&(Et(a,!1),ce(a));else Et(this,r)}var no=r=>{r.type==D.CHILD&&(r._$AP??=io,r._$AQ??=oo)},dt=class extends U{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,a){super._$AT(t,e,a),Dr(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(Et(this,t),ce(this))}setValue(t){if(Or(this._$Ct))this._$Ct._$AI(t,this);else{let e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}};var Be=!1,Fe=new S.subtle.Watcher(async()=>{Be||(Be=!0,queueMicrotask(()=>{Be=!1;for(let r of Fe.getPending())r.get();Fe.watch()}))}),he=class extends dt{_$S_(){var t,e;this._$Sm===void 0&&(this._$Sj=new S.Computed(()=>{var a;let o=(a=this._$SW)===null||a===void 0?void 0:a.get();return this.setValue(o),o}),this._$Sm=(e=(t=this._$Sk)===null||t===void 0?void 0:t.h)!==null&&e!==void 0?e:Fe,this._$Sm.watch(this._$Sj),S.subtle.untrack(()=>{var a;return(a=this._$Sj)===null||a===void 0?void 0:a.get()}))}_$Sp(){this._$Sm!==void 0&&(this._$Sm.unwatch(this._$SW),this._$Sm=void 0)}render(t){return S.subtle.untrack(()=>t.get())}update(t,[e]){var a,o;return(a=this._$Sk)!==null&&a!==void 0||(this._$Sk=(o=t.options)===null||o===void 0?void 0:o.host),e!==this._$SW&&this._$SW!==void 0&&this._$Sp(),this._$SW=e,this._$S_(),S.subtle.untrack(()=>this._$SW.get())}disconnected(){this._$Sp()}reconnected(){this._$S_()}},Ge=O(he);var Ke=r=>(t,...e)=>r(t,...e.map(a=>a instanceof S.State||a instanceof S.Computed?Ge(a):a)),so=Ke(g),lo=Ke(wr);var mn=S.State,bn=S.Computed,F=(r,t)=>new S.State(r,t),de=(r,t)=>new S.Computed(r,t);var co=[{pattern:/^\/(search)?$/,name:"search"},{pattern:/^\/view\/(.+)/,name:"view"},{pattern:/^\/about$/,name:"about"}];function jr(r,t=""){for(let{pattern:e,name:a}of co){let o=e.exec(r);if(o)return{name:a,path:o[1],params:new URLSearchParams(t)}}return{name:"not-found",params:new URLSearchParams(t)}}var I=F(jr(window.location.pathname,window.location.search));window.addEventListener("popstate",()=>{I.set(jr(window.location.pathname,window.location.search))});var En=m`
  .matchstr {
...
`))!==-1;){let c=o.slice(0,s).trim();o=o.slice(s+1),c.length!==0&&t(JSON.parse(c))}}o+=a.decode();let i=o.trim();i.length>0&&t(JSON.parse(i))}finally{e.releaseLock()}}function pt(r){let t=r.indexOf("/+/");if(t===-1)return{repo:r,version:"",filePath:""};let e=r.slice(0,t),a=r.slice(t+3),o=e.lastIndexOf("/");return o===-1?{repo:e,version:"",filePath:a}:{repo:e.slice(0,o),version:e.slice(o+1),filePath:a}}function aa(r,t={},e={}){let a=new URLSearchParams;if(r.trim()&&a.set("q",r.trim()),t.literal&&a.set("literal","true"),t.caseSensitive&&a.set("fold_case","false"),t.repos?.length)for(let o of t.repos)a.append("repo",o);for(let[o,i]of Object.entries(e))for(let n of i)a.append(o,n);return a}var ye=class{constructor(){this.lastCommittedUrl=""}commit(t,e={},a={}){let o=aa(t,e,a),i=t?`${t} \xB7 code search`:"code search",n=ve(o);if(!t)return this.lastCommittedUrl="",[{type:"replaceUrl",url:ve(new URLSearchParams),title:i},{type:"clearResults"}];let h=[];return n!==this.lastCommittedUrl&&this.lastCommittedUrl!==""?h.push({type:"pushUrl",url:n,title:i}):h.push({type:"replaceUrl",url:n,title:i}),h.push({type:"search",params:o}),this.lastCommittedUrl=n,h}popstate(t,e){this.lastCommittedUrl=ve(e);let a=t?`${t} \xB7 code search`:"code search",o=[{type:"replaceUrl",url:ve(e),title:a}];return t?o.push({type:"search",params:e}):o.push({type:"clearResults"}),o}};function ve(r){let t=r.toString();return"/search"+(t?"?"+t:"")}var ke=class{constructor(){this.results=[];this.files=[];this.dirty=!1;this.flushed=!1}start(){return this.results=[],this.files=[],this.dirty=!1,this.flushed=!1,{loading:!0,error:null,done:null}}onResult(t){this.results.push(t),this.dirty=!0}onFile(t){this.files.push(t),this.dirty=!0}flush(){if(!this.dirty)return null;this.dirty=!1;let t={results:[...this.results],files:[...this.files]};return this.flushed||(t.facets=null,this.flushed=!0),t}onFacets(t){return{facets:t}}onDone(t){return{results:this.results,files:this.files,done:t,loading:!1}}onError(t){return{error:t,loading:!1}}};var ft=de(()=>I.get().params.get("q")??""),ks=de(()=>{let r=I.get().params;return{literal:r.get("literal")==="true",caseSensitive:r.get("fold_case")==="false"}}),oa=de(()=>{let r=I.get().params.get("context");if(r!==null){let t=parseInt(r,10);if(!isNaN(t)&&t>=0)return t}return 3}),Lt=F([]),Rt=F([]),Mt=F(null),It=F(null),Ot=F(!1),Nt=F(null),Xe=null;async function _o(){Xe&&Xe.abort();let r=new AbortController;if(Xe=r,!ft.get()){Lt.set([]),Rt.set([]),Mt.set(null),It.set(null),Ot.set(!1),Nt.set(null);return}let e=I.get(),a=new URLSearchParams(e.params),o=new ke;zt(o.start());let i=setInterval(()=>{let n=o.flush();n&&zt(n)},100);try{await ra(a,{onResult(n){o.onResult(n)},onFile(n){o.onFile(n)},onFacets(n){zt(o.onFacets(n))},onDone(n){clearInterval(i),zt(o.onDone(n))}},r.signal)}catch(n){clearInterval(i),r.signal.aborted||zt(o.onError(n instanceof Error?n.message:String(n)))}}function zt(r){"results"in r&&Lt.set(r.results),"files"in r&&Rt.set(r.files),"facets"in r&&Mt.set(r.facets),"done"in r&&It.set(r.done),"loading"in r&&Ot.set(r.loading),"error"in r&&Nt.set(r.error)}var _e=new ye,et=null;function ia(r,t={},e={}){et&&clearTimeout(et),et=setTimeout(()=>{et=null,xe(_e.commit(r,t,e))},200)}function we(r,t={},e={}){et&&(clearTimeout(et),et=null),xe(_e.commit(r,t,e))}function wo(){let r=ft.get();r&&xe(_e.commit(r))}wo();window.addEventListener("popstate",()=>{let r=I.get(),t=r.params.get("q")??"";xe(_e.popstate(t,r.params))});function xe(r){for(let t of r)switch(t.type){case"pushUrl":history.pushState(null,t.title,t.url),document.title=t.title,I.set({name:"search",params:new URLSearchParams(new URL(t.url,location.origin).search)});break;case"replaceUrl":history.replaceState(null,t.title,t.url),document.title=t.title,I.set({name:"search",params:new URLSearchParams(new URL(t.url,location.origin).search)});break;case"search":_o();break;case"clearResults":Lt.set([]),Rt.set([]),Mt.set(null),It.set(null),Ot.set(!1),Nt.set(null);break}}var rt=class extends b{constructor(){super(...arguments);this.value="";this.error=""}render(){return g`
    ...
    `,d([u({type:Array})],q.prototype,"groups",2),d([T()],q.prototype,"_open",2),d([T()],q.prototype,"_search",2),d([T()],q.prototype,"_selected",2),q=d([_("repo-select")],q);var at=class extends b{constructor(){super(...arguments);this.options={};this.repos=[]}render(){let e=this.options.caseSensitive?"false":"auto";return g`
    ...
    `,d([u()],N.prototype,"text",2),d([u()],N.prototype,"href",2),d([u({type:Number})],N.prototype,"start",2),d([u({type:Number})],N.prototype,"end",2),d([u()],N.prototype,"repo",2),d([u()],N.prototype,"version",2),N=d([_("filename-match")],N);var H=class extends b{render(){let t=this.start!=null&&this.end!=null;return g`<a class=${tr({"lno-link":!0,matchlno:t})} href="${this.href}"
                ><span class="lno">${this.lineNo}</span></a
            >
            <span class=${tr({matchline:t})}
                >${t?g`<match-str
                          text="${this.text}"
                          start=${this.start}
                          end=${this.end}
    ...
    `,d([u({type:Number})],H.prototype,"lineNo",2),d([u()],H.prototype,"text",2),d([u()],H.prototype,"href",2),d([u({type:Number})],H.prototype,"start",2),d([u({type:Number})],H.prototype,"end",2),H=d([_("match-line")],H);function xo(r){let t=r.lastIndexOf("/");return t<0?".":r.slice(0,t)}function So(r){let t=r.lastIndexOf("/");return t<0?r:r.slice(t+1)}var ot=class extends b{constructor(){super(...arguments);this.noContext=!1}render(){let{repo:e,version:a,filePath:o}=pt(this.result.path),i=`/view/${this.result.path}`,n=this.splitGroups(this.result.lines),h=a.length>6?a.slice(0,6):a,s=xo(o),c=So(o);return g`
      <div class="file-group">
        <div class="header">
          <span class="header-path">
            <a class="result-path" href=${i}>
              <span class="repo">${e}:</span><span class="version">${h}:</span>${s}/<span class="filename">${c}</span>
            </a>
          </span>
        </div>
        ${n.map(p=>g`
            <div class="match">
              <div class="contents">
                ${p.map(l=>{let k=l[0],f=l[1],v=l.length>2?l[2]:void 0,C=v!==void 0&&v.length>0,W=`${i}#L${k}`,R=C&&v?v[0][0]:void 0,$e=C&&v?v[0][1]:void 0;return g`
                    <match-line
    ...
    `}splitGroups(e){let a=[],o=[];for(let i of e)i===null?o.length>0&&(a.push(o),o=[]):o.push(i);return o.length>0&&a.push(o),a}};ot.styles=[qr,j,m`
      :host {
        display: block;
      }
    ...
    `],d([u({type:Object})],ot.prototype,"result",2),d([u({type:Boolean,reflect:!0,attribute:"no-context"})],ot.prototype,"noContext",2),ot=d([_("cs-result-group")],ot);var G=class extends b{constructor(){super(...arguments);this.total=0;this.timeMs=0;this.truncated=!1;this.loading=!1}render(){if(this.loading)return g`<div id="countarea">Searching...</div>`;let e=this.truncated?`${this.total}+`:`${this.total}`;return g`
      <div id="countarea">
    ...
    `],d([u({type:Number})],G.prototype,"total",2),d([u({type:Number})],G.prototype,"timeMs",2),d([u({type:Boolean})],G.prototype,"truncated",2),d([u({type:Boolean})],G.prototype,"loading",2),G=d([_("cs-result-stats")],G);var it=class extends b{constructor(){super(...arguments);this.facets=null;this.selected={}}render(){let e=this.facets&&(this.facets.ext?.length||this.facets.repo?.length||this.facets.path?.length),a=Object.values(this.selected).some(n=>n.size>0);if(!e&&!a)return w;let i=[{label:"Extension",key:"f.ext",buckets:this.facets?.ext??[]},{label:"Repository",key:"f.repo",buckets:this.facets?.repo??[]},{label:"Path",key:"f.path",buckets:this.facets?.path??[]}].filter(n=>n.buckets.length>0||(this.selected[n.key]?.size??0)>0);return i.length===0?w:g`
      <div class="panel">
        ${i.map(n=>this.renderSection(n.label,n.key,n.buckets))}
      </div>
    `}renderSection(e,a,o){let i=this.selected[a]??new Set,h=[...o].sort((p,l)=>l.c-p.c||p.v.localeCompare(l.v)).slice(0,10),s=new Set(h.map(p=>p.v)),c=[...i].filter(p=>!s.has(p));return g`
      <div class="section">
    ...
    `}toggle(e,a){this.dispatchEvent(new CustomEvent("facet-toggle",{detail:{key:e,value:a},bubbles:!0,composed:!0}))}};it.styles=m`
    :host {
      display: block;
    }
  ...
  `,d([u({type:Object})],it.prototype,"facets",2),d([u({type:Object})],it.prototype,"selected",2),it=d([_("cs-facet-panel")],it);var Ut=class extends b{render(){return g`
      <div id="helparea">
    ...
    `],Ut=d([_("cs-search-help")],Ut);function $o(r,t,e){let a=r[t]??new Set,o;return t==="f.path"?o=a.has(e)?new Set:new Set([e]):(o=new Set(a),o.has(e)?o.delete(e):o.add(e)),{...r,[t]:o}}function Eo(r){let t={};for(let[e,a]of Object.entries(r))a.size>0&&(t[e]=[...a]);return t}function Co(r){let t={};for(let e of["f.ext","f.repo","f.path"]){let a=r.getAll(e);a.length>0&&(t[e]=new Set(a))}return t}var Dt=class extends $t(b){constructor(){super(...arguments);this.currentOptions={}}get activeFacets(){return Co(I.get().params)}render(){let e=ft.get(),a=Lt.get(),o=Rt.get(),i=It.get(),n=Ot.get(),h=Nt.get(),s=Mt.get(),c=oa.get(),p=i||n;return g`
      <div id="searcharea">
        <form
          autocapitalize="off"
          autocomplete="off"
      ...
      <div id="resultbox">
        ${p?g`
          <div id="resultarea">
            ...
            >
              <div id="path-results">
                ${o.map(l=>{let{repo:k,version:f,filePath:v}=pt(l.path);return g`
                    <filename-match
                      text=${v}
                      start=${l.match[0]}
                      end=${l.match[1]}
              ...
              <div id="code-results">
                ${ea({items:a,renderItem:l=>g`
                    <cs-result-group .result=${l} ?no-context=${c<=0}></cs-result-group>
                  `})}
              </div>
            </div>
          </div>
    ...
    `}onFacetToggle(e){let a=$o(this.activeFacets,e.detail.key,e.detail.value),o=ft.get();o&&we(o,this.currentOptions,this.facetParamsFrom(a))}onSearchInput(e){ia(e.detail.value,this.currentOptions,this.facetParamsFrom(this.activeFacets))}onSearchSubmit(e){we(e.detail.value,this.currentOptions,this.facetParamsFrom(this.activeFacets))}onOptionsChange(e){this.currentOptions=e.detail,this.reSearch()}reSearch(){let e=ft.get();e&&we(e,this.currentOptions,this.facetParamsFrom(this.activeFacets))}getRepos(){return window.__CS_INIT?.repos??[]}facetParamsFrom(e){return Eo(e)}};Dt.styles=[j,gt,m`
      :host {
        display: block;
        line-height: normal;
        font-size: 13px;
    ...
    `],Dt=d([_("cs-search-view")],Dt);var ut=class extends b{constructor(){super(...arguments);this.path=""}render(){let e=this.path.indexOf("/+/");if(e===-1)return g`<span>${this.path}</span>`;let a=this.path.slice(0,e),i=this.path.slice(e+3).split("/").filter(n=>n.length>0);return g`
      <nav class="breadcrumbs">
        <a href="/view/${a}/+/">${a}</a>
        ${i.map((n,h)=>{let s=i.slice(0,h+1).join("/"),c=`/view/${a}/+/${s}${h<i.length-1?"/":""}`;return g`<span class="sep">/</span><a href=${c}>${n}</a>`})}
      </nav>
    `}};ut.styles=m`
    .breadcrumbs {
  ...
  `,d([u()],ut.prototype,"path",2),ut=d([_("cs-breadcrumbs")],ut);var nt=class extends b{constructor(){super(...arguments);this.entries=[];this.basePath=""}render(){let e=[...this.entries].sort((a,o)=>{let i=a.endsWith("/"),n=o.endsWith("/");return i!==n?i?-1:1:a.localeCompare(o)});return g`
      <div class="listing">
  ...
  `,d([u({type:Array})],nt.prototype,"entries",2),d([u()],nt.prototype,"basePath",2),nt=d([_("cs-dir-listing")],nt);var jt=class extends U{constructor(t){if(super(t),this.it=w,t.type!==D.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===w||t==null)return this._t=void 0,this.it=t;if(t===P)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;let e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};jt.directiveName="unsafeHTML",jt.resultType=1;var na=O(jt);var Ao="2.16.0",To=["ada","agda","asciidoc","asm","awk","bash","batch","c","c-sharp","caddy","capnp","cedar","cedarschema","clojure","cmake","cobol","commonlisp","cpp","css","d","dart","devicetree","diff","dockerfile","dot","elisp","elixir","elm","erlang","fish","fsharp","gleam","glsl","go","graphql","groovy","haskell","hcl","hlsl","html","idris","ini","java","javascript","jinja2","jq","json","julia","kotlin","lean","lua","markdown","matlab","meson","nginx","ninja","nix","objc","ocaml","perl","php","postscript","powershell","prolog","python","query","r","rego","rescript","ron","ruby","rust","scala","scheme","scss","solidity","sparql","sql","ssh-config","starlark","styx","svelte","swift","textproto","thrift","tlaplus","toml","tsx","typescript","typst","uiua","vb","verilog","vhdl","vim","vue","wit","x86asm","xml","yaml","yuri","zig","zsh"];function Po(r){return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}var nr={manual:!1,theme:"one-dark",selector:"pre code",cdn:"jsdelivr",version:Ao,pluginsUrl:"",hostUrl:"",logger:console,resolveHostJs:({baseUrl:r,path:t})=>import(`${r}/${t}`),resolveHostWasm:({baseUrl:r,path:t})=>fetch(`${r}/${t}`),resolveJs:({baseUrl:r,path:t})=>import(`${r}/${t}`),resolveWasm:({baseUrl:r,path:t})=>fetch(`${r}/${t}`)},er=null,rr=null,Se={...nr},sr=new Map,ar=new Map,sa=new Set(To),qt=null,or=null;async function zo(r){if(r.pluginsUrl)return or||(or=(async()=>{r.logger.debug(`[arborium] Loading local plugins manifest from: ${r.pluginsUrl}`);let t=await fetch(r.pluginsUrl);if(!t.ok)throw new Error(`Failed to load plugins.json: ${t.status}`);qt=await t.json(),r.logger.debug(`[arborium] Loaded local manifest with ${qt?.entries.length} entries`)})(),or)}function Lo(r,t){if(qt){let i=qt.entries.find(n=>n.language===r);if(i)return i.local_js.substring(0,i.local_js.lastIndexOf("/"))}let e=t.cdn,a=t.version,o;return e==="jsdelivr"?o="https://cdn.jsdelivr.net/npm":e==="unpkg"?o="https://unpkg.com":o=e,`${o}/@arborium/${r}@${a}`}async function Ro(r,t){let e=sr.get(r);if(e)return t.logger.debug(`[arborium] Grammar '${r}' found in cache`),e;let a=ar.get(r);if(a)return t.logger.debug(`[arborium] Grammar '${r}' already loading, waiting...`),a;let o=Mo(r,t);ar.set(r,o);try{return await o}finally{ar.delete(r)}}async function Mo(r,t){if(await zo(t),!sa.has(r)&&!qt?.entries.some(e=>e.language===r))return t.logger.debug(`[arborium] Grammar '${r}' not available`),null;try{let e=Lo(r,t),a=t.resolveJs===nr.resolveJs?` from ${e}/grammar.js`:"";t.logger.debug(`[arborium] Loading grammar '${r}'${a}`);let o=await t.resolveJs({language:r,baseUrl:e,path:"grammar.js"}),i=await t.resolveWasm({language:r,baseUrl:e,path:"grammar_bg.wasm"});await o.default({module_or_path:i});let n=o.language_id();n!==r&&t.logger.warn(`[arborium] Language ID mismatch: expected '${r}', got '${n}'`);let h=o.injection_languages(),s={languageId:r,injectionLanguages:h,module:o,parseUtf8:c=>{let p=o.create_session();try{o.set_text(p,c);let l=o.parse(p);return{spans:l.spans||[],injections:l.injections||[]}}catch(l){return t.logger.error("[arborium] Parse error:",l),{spans:[],injections:[]}}finally{o.free_session(p)}},parseUtf16:c=>{let p=o.create_session();try{o.set_text(p,c);let l=o.parse_utf16(p);return{spans:l.spans||[],injections:l.injections||[]}}catch(l){return t.logger.error("[arborium] Parse error:",l),{spans:[],injections:[]}}finally{o.free_session(p)}}};return sr.set(r,s),t.logger.debug(`[arborium] Grammar '${r}' loaded successfully`),s}catch(e){return t.logger.error(`[arborium] Failed to load grammar '${r}':`,e),null}}var ir=new Map,Io=1;function Oo(r){globalThis.arboriumHost={isLanguageAvailable(t){return sa.has(t)||sr.has(t)},async loadGrammar(t){let e=await Ro(t,r);if(!e)return 0;for(let[o,i]of ir)if(i===e)return o;let a=Io++;return ir.set(a,e),a},parse(t,e){let a=ir.get(t);return a?a.parseUtf8(e):{spans:[],injections:[]}}}}function No(r){if(r.hostUrl)return r.hostUrl;let t=r.cdn,e=r.version,a;t==="jsdelivr"?a="https://cdn.jsdelivr.net/npm":t==="unpkg"?a="https://unpkg.com":a=t;let o=e==="latest"?"":`@${e}`;return`${a}/@arborium/arborium${o}/dist`}async function Uo(r){return er||rr||(rr=(async()=>{Oo(r);let t=No(r),e=r.resolveHostJs===nr.resolveHostJs?` from ${t}/arborium_host.js`:"";r.logger.debug(`[arborium] Loading host${e}`);try{let a=await r.resolveHostJs({baseUrl:t,path:"arborium_host.js"}),o=await r.resolveHostWasm({baseUrl:t,path:"arborium_host_bg.wasm"});return await a.default({module_or_path:o}),er={highlight:a.highlight,isLanguageAvailable:a.isLanguageAvailable},r.logger.debug("[arborium] Host loaded successfully"),er}catch(a){return r.logger.error("[arborium] Failed to load host:",a),null}})(),rr)}async function la(r,t,e){let a=Do(e),o=await Uo(a);if(o)try{return o.highlight(r,t)}catch(i){a.logger.error("[arborium] Host highlight failed:",i)}return Po(t)}function Do(r){return r?{...Se,...r}:{...Se}}function ca(r){Se={...Se,...r}}var ha={".go":"go",".py":"python",".rs":"rust",".ts":"typescript",".tsx":"tsx",".js":"javascript",".jsx":"jsx",".c":"c",".h":"c",".cc":"cpp",".cpp":"cpp",".hpp":"cpp",".java":"java",".rb":"ruby",".sh":"bash",".bash":"bash",".zsh":"bash",".fish":"fish",".clj":"clojure",".cljs":"clojure",".cljc":"clojure",".yaml":"yaml",".yml":"yaml",".json":"json",".toml":"toml",".md":"markdown",".html":"html",".css":"css",".scss":"scss",".sql":"sql",".lua":"lua",".zig":"zig",".swift":"swift",".kt":"kotlin",".scala":"scala",".r":"r",".el":"elisp",".ex":"elixir",".erl":"erlang",".hs":"haskell",".ml":"ocaml",".fs":"fsharp",".proto":"protobuf",".tf":"hcl",".dockerfile":"dockerfile",".makefile":"make",".xml":"xml",".svg":"xml"},da={Makefile:"make",makefile:"make",GNUmakefile:"make",Dockerfile:"dockerfile","CMakeLists.txt":"cmake",".gitignore":"gitignore",".bashrc":"bash",".zshrc":"bash",".profile":"bash"};function jo(r){let t=r.split("/").pop()??"";if(da[t])return da[t];let e=t.lastIndexOf(".");if(e>=0){let a=t.slice(e).toLowerCase();if(ha[a])return ha[a]}return""}ca({logger:{debug:()=>{},warn:console.warn,error:console.error}});async function ga(r,t){let e=jo(r);if(!e)return null;try{return(await la(e,t)).split(`
`)}catch{return null}}var pa=`/* Arborium base CSS - handles light/dark switching */
...
`);e.length>0&&e[e.length-1]===""&&e.pop();let a=this.highlightedLines;return g`
      ...
      `:""}
      <div class="viewer">
        ${e.map((o,i)=>{let n=i+1,h=n>=this.selectedStart&&n<=this.selectedEnd;return g`
            <div class="line ${h?"selected":""}" id="L${n}">
              <a class="lno" href="#L${n}" @click=${s=>this.onLineClick(s,n)}>${n}</a>
              <span class="code">${a&&a[i]?na(a[i]):o}</span>
            </div>
          `})}
      </div>
    `}onLineClick(e,a){if(e.shiftKey&&this.selectedStart>0){e.preventDefault();let o=Math.min(this.selectedStart,a),i=Math.max(this.selectedStart,a);this.selectedStart=o,this.selectedEnd=i,history.replaceState(null,"",`#L${o}-L${i}`)}else this.selectedStart=a,this.selectedEnd=a}};z.styles=[Gt(pa),m`
    .selection-hint {
      font-size: 11px;
      color: var(--color-foreground-subtle);
      padding: 4px 8px;
  ...
  `],d([u()],z.prototype,"content",2),d([u()],z.prototype,"basePath",2),d([u()],z.prototype,"filePath",2),d([u()],z.prototype,"repo",2),d([u()],z.prototype,"version",2),d([u()],z.prototype,"externalUrl",2),d([T()],z.prototype,"selectedStart",2),d([T()],z.prototype,"selectedEnd",2),d([T()],z.prototype,"hasSelection",2),d([T()],z.prototype,"highlightedLines",2),z=d([_("cs-code-viewer")],z);var mt=class extends b{constructor(){super(...arguments);this.open=!1}render(){return this.open?g`
    ...
    `:g``}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close-help",{bubbles:!0,composed:!0}))}};mt.styles=m`
    .overlay {
      position: fixed;
      inset: 0;
  ...
  `,d([u({type:Boolean,reflect:!0})],mt.prototype,"open",2),mt=d([_("cs-help-modal")],mt);function Ko(r){let t=r.indexOf("/+/");if(t>=0){let e=r.slice(0,t),a=r.slice(t+3),o=e.lastIndexOf("@");if(o>=0)return{repo:e.slice(0,o),version:e.slice(o+1),filePath:a}}return pt(r)}function Jo(r){return r.endsWith("/")||r.endsWith("/+/")||!r.includes("/+/")}function Yo(r,t){return`/raw/${r}${t&&!r.endsWith("/")?"/":""}`}function Qo(r,t,e){let a="github.com/";return r.startsWith(a)?`https://github.com/${r.slice(a.length)}/blob/${t}/${e}#L{lno}`:""}var L=class extends b{constructor(){super(...arguments);this.path="";this.content=null;this.dirEntries=null;this.readmeContent=null;this.loading=!0;this.error=null;this.showHelp=!1}willUpdate(e){e.has("path")&&this.fetchContent()}async fetchContent(){this.loading=!0,this.error=null,this.content=null,this.dirEntries=null,this.readmeContent=null;let e=Jo(this.path),a=Yo(this.path,e);try{let o=await fetch(a);if(!o.ok){this.error=`Not found (${o.status})`,this.loading=!1;return}(o.headers.get("Content-Type")??"").includes("application/json")?(this.dirEntries=await o.json(),this.fetchReadme(a)):this.content=await o.text()}catch(o){this.error=o instanceof Error?o.message:String(o)}this.loading=!1}async fetchReadme(e){if(!this.dirEntries)return;let a=this.dirEntries.find(o=>L.README_RE.test(o));if(a)try{let o=e.endsWith("/")?e:e+"/",i=await fetch(o+a);i.ok&&(this.readmeContent=await i.text())}catch{}}render(){let e=Ko(this.path),a=e.repo,o=e.version,i=Qo(e.repo,e.version,e.filePath);return g`
      <div class="file-view">
    ...
    `}};L.README_RE=/^readme\.(md|markdown|mdown|mkdn|txt|rst|org|adoc|asc)$/i,L.styles=m`
    .file-view {
      max-width: 1200px;
      margin: 0 auto;
      padding: 16px;
  ...
  `,d([u()],L.prototype,"path",2),d([T()],L.prototype,"content",2),d([T()],L.prototype,"dirEntries",2),d([T()],L.prototype,"readmeContent",2),d([T()],L.prototype,"loading",2),d([T()],L.prototype,"error",2),d([T()],L.prototype,"showHelp",2),L=d([_("cs-file-view")],L);var Ht=class extends b{render(){return g`
      <div class="about">
        <p>
    ...
    `],Ht=d([_("cs-about-view")],Ht);var Wt=class extends $t(b){render(){let t=I.get();return g`
    ...
    `}renderView(t){switch(t.name){case"search":return g`<cs-search-view></cs-search-view>`;case"view":return g`<cs-file-view .path=${t.path??""}></cs-file-view>`;case"about":return g`<cs-about-view></cs-about-view>`;default:return g`<div class="placeholder">Not found</div>`}}};Wt.styles=[j,m`
      :host {
        display: block;
      }
    ...
    `],Wt=d([_("cs-app")],Wt);export{Wt as CsApp};
